...
function svg($parent, type) {
  ...
  $parent.html(`
    <svg class="ve-menu-svg" width="16px" height="16px" viewbox="0 0 16 16" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
      <title>${cfg.menu.lang[type]}</title>
